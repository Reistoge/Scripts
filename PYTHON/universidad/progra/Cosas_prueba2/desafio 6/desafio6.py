...
def imprimir_datos(_ciudad_ano,_pais,info,_pais2):
    print(f"Información de Juegos Olimpicos {_ciudad_ano.capitalize()}")
    print(f"Datos Sobre {_pais2}")
...
while linea!="":
    ...
    linea=arch.readline().strip()
if pais2!="":
    imprimir_datos(ciudad_ano, pais, info,pais2)  
